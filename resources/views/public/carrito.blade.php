...
@section('contenido')
    ...
    @if (Cart::isEmpty())
        ...
        <h3 class="display-5 mb-5 text-center">Carrito de compras</h3>

        <div class="d-flex justify-content-center">
            <div class="alert alert-dark w-75 text-center" style="background-color: #000; color: #FFF" role="alert">
                <h4 class="alert-heading">¡Carrito vacio!</h4>
                <br>
                <p style="color: #FFF">Aún no tienes ningún producto agregado en tu carrito de compras, puedes ver todo
                    nuestro catalogo desde el menú de arriba o dando clic al boton que tenemos aquí abajo</p>
                <hr>
                <a href="{{ route('catalogo.index') }}"><button type="button" class="btn btn-light"
                        style="background-color: #FFF;">Ver catálogo</button></a>
            </div>
        </div>
            ...
            <div class="container">
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        @if ($message = Session::get('success'))
                            <div class="p-4 mb-3 bg-green-400 rounded">
                                ...
                                <div class="alert alert-dark" role="alert" style="background: #000; color: #FFF">
                                    {{ $message }}
                                </div>

                            </div>
                        @endif
                        <a href="{{ route('catalogo.index') }}" style="color: black">
                            <i class="fa fa-chevron-left" aria-hidden="true"></i> &nbsp; Continuar viendo
                        </a>
                        <a href="{{ route('cart.clear') }}" class="float-end">
                            <button class="btn btn-dark"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp; Vaciar
                                carrito</button>
                        </a>
                        <br><br>
                ...
                <div class="row mt-4 d-flex align-items-center">
                    <div class="col-sm-12 order-md-2 text-center">
                        <a href="{{ route('cart.confirm.sale') }}" class="btn btn-dark mb-4 btn-lg pl-5 pr-5">Confirmar
                            Compra</a>
                    </div>
