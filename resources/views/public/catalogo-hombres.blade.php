...
@section('contenido')
    ...
    <style>
        .page-heading {
            ...
            background-image: url('{{ asset('assets/images/catalogo_background.jpg') }}') !important;
                                    ...
                                    @foreach ($trademarks as $trade)
                                        ...
                                        @if (isset($filtroTrade))
                                            @if ($filtroTrade == $trade->name)
                                                <input type="radio" class="btn-check" name="filtro" id="vbtn{{ $trade->name }}" autocomplete="off" checked value="{{ $trade->name }}" onclick="javascript: submit()">
                                                <label class="btn btn-outline-dark" style="color: #FFF !important" for="vbtn{{ $trade->name }}">{{ $trade->name }}</label>
                                            @else
                                                <input type="radio" class="btn-check" name="filtro" id="vbtn{{ $trade->name }}" autocomplete="off" onclick="javascript: submit()" value="{{ $trade->name }}">
                                                <label class="btn btn-outline-dark" for="vbtn{{ $trade->name }}">{{ $trade->name }}</label>
                                            @endif
                                        @else
                                            <input type="radio" class="btn-check" name="filtro" id="vbtn{{ $trade->name }}" autocomplete="off" onclick="javascript: submit()" value="{{ $trade->name }}">
                                            <label class="btn btn-outline-dark" for="vbtn{{ $trade->name }}">{{ $trade->name }}</label>
