<form action="" method="post" class="needs-validation" novalidate>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-12">
            ...
            <input class="form-control" type="text" name="name" id="name" placeholder="Marca..." required value="">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-12">
            ...
            <textarea class="form-control" name="description" id="description" cols="30" rows="3" placeholder="Descripción de la marca...">{{-- value --}}</textarea>
            <div class="invalid-feedback">
                Ingrese un nombre
            </div>
            <div class="valid-feedback">
